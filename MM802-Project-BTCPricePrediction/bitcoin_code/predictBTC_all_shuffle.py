...
def split_data(stock, stock1, stock2, stock3, stock4, lookback):
    ...
    np.random.seed(2021)
    np.random.shuffle(hr_data)
    np.random.seed(2021)
    np.random.shuffle(sen_data)     
    np.random.seed(2021)
    np.random.shuffle(vec_data)     
...
def main():
    ...
    save_dir = './result_shuffle/result/'+ patten +'/'+ mo_use + '/'
    mod_dir = './result_shuffle/model/'+ patten +'/'+ mo_use + '/'
