...
filepath = './dataset/AMZN_2006-01-01_to_2018-01-01.csv'
...
fig1.canvas.set_window_title('Amazon Stock Price')
plt.plot(data[['Close']])
...
plt.legend(loc='best')
plt.show()
#plt.savefig(save_dir+'stock_price.jpg')
...
fig2.canvas.set_window_title('Stock price & Training Loss (LSTM)')
...
plt.legend(loc='best')
plt.show()
#plt.savefig(save_dir+'lstm+stock_price&train_loss.jpg')
...
fig4.canvas.set_window_title('Stock price & Training Loss (GRU)')
...
#plt.legend(loc='best')
plt.show()
#plt.savefig(save_dir+'gru_stock_price&train_loss.jpg')
